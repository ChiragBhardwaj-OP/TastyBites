...
class _TabsScreenState extends ConsumerState<TabsScreen> {
  ...
  void _setScreen(String identifier) async {
    //async is used for future value
    ...
    if (identifier == 'filters') {
      ...
      ); //push replacement replaces the active screen so that the back button would nor work.
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        onTap: _selectPage,
        currentIndex: _selectedPageIndex, //controlls which tab is highlighted.
        items: const [
